...
role :web, "imdb.com"                          # Your HTTP server, Apache/etc
role :app, "imdb.com"                         # This may be the same as your `Web` server
role :db,  "imdb.com"   , :primary => true # This is where Rails migrations will run
